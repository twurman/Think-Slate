...
const byte ledPin = 7;
const byte speakerOut = 6; /* This makes a standard old PC speaker connector fit nicely over the pins. */
...
int noteDurations[] = {
8,4,4,8,4,2,2,
3,3,3,4,4,8,4,8,8,8,4,8,4,4,8,8,3,
3,3,3,4,4,8,4,8,8,8,4,8,4,4,8,8,2,
